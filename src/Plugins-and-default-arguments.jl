...
plugins = PluginInfo.([
    (true, "ProjectFile", "Creates a Project.toml", [("version",  false, "v\"1.0.0-DEV\"", "The initial version of created packages")]),
    (true, "SrcDir", "Creates a module entrypoint", [("file",  false, "~/work/PkgTemplates.jl/PkgTemplates.jl/templates/src/module.jl", "Template file for src/$(packagename).jl")]),
    (true, "Tests", "Sets up testing for packages", [("file",  false, "~/work/PkgTemplates.jl/PkgTemplates.jl/templates/test/runtests.jl", "Template file for runtests.jl")
                ("project",  false, false, "Whether or not to create a new project for tests (test/Project.toml).")]),
    (false, "Readme", "Creates a README file that contains badges for other included plugins.", [("file",  false, "~/work/PkgTemplates.jl/PkgTemplates.jl/templates/README.md", ""), 
    ...
    (true, "License", "Creates a license file", [("name",  false, "MIT", "Name of a license supported by PkgTemplates. Dropdown menu to be added here!"), 
    ...
    (true, "Git", "Creates a Git repository and a .gitignore file", [("ignore",  true, String[], "Patterns to add to the .gitignore"), 
                ...
                ("branch",  false, "LibGit2.getconfig(\"init.defaultBranch\", \"main\")", "The desired name of the repository's default branch."), 
    ...
    (true, "CompatHelper", "Integrates your packages with CompatHelper via GitHub Actions", [("file",  false, "~/work/PkgTemplates.jl/PkgTemplates.jl/templates/github/workflows/CompatHelper.yml", "Template file for the workflow file"), 
    ...
    (true, "TagBot", "Adds GitHub release support via TagBot", [("file",  false, "~/work/PkgTemplates.jl/PkgTemplates.jl/templates/github/workflows/TagBot.yml", "Template file for the workflow file."), 
                ...
                ("token",  false, "Secret(\"GITHUB_TOKEN\")", "Name of the token secret to use"), 
                ("ssh",  false, "Secret(\"DOCUMENTER_KEY\")", "Name of the SSH private key secret to use"), 
