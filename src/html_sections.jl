...
<button type="submit" id="subm0" value="Cancel_0" onclick="sendfullstate('finalinputcancelled')">Cancel</button>
&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
<button type="submit" id="subm2" value="Reload_3" onclick="reload_window()" >Reset form</button>
&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
<button type="submit" id="subm1" value="Submit_1" onclick="sendfullstate('finalinputfinished')" disabled>Create package</button>
</form>
</div>
"""
