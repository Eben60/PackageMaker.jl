...
fv = Dict{Symbol, HtmlElem}(
    ...
    :Git_name => PackageMaker.HtmlElem(:Git_name, :input, String[], :text, :Git_form, "NoName", false),
    ...
    :Use_Git => PackageMaker.HtmlElem(:Use_Git, :input, ["TogglePlugin"], :checkbox, :Git_form, "Use_Git", true),
    ...
    :Use_SrcDir => PackageMaker.HtmlElem(:Use_SrcDir, :input, ["TogglePlugin"], :checkbox, :SrcDir_form, "Use_SrcDir", false),
