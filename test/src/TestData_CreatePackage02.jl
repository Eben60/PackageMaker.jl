...
fv = Dict{Symbol, HtmlElem}(
    ...
    :GeneralOptions_docstring => HtmlElem(:GeneralOptions_docstring, :textarea, String[], :textarea, :GeneralOptions_form, "", nothing),
    :GeneralOptions_host => HtmlElem(:GeneralOptions_host, :input, String[], :text, :GeneralOptions_form, "github.com", false),
    :GeneralOptions_is_package => HtmlElem(:GeneralOptions_is_package, :input, String[], :checkbox, :GeneralOptions_form, "on", false),
    :GeneralOptions_jl_suffix => HtmlElem(:GeneralOptions_jl_suffix, :input, String[], :checkbox, :GeneralOptions_form, "on", true),
    :GeneralOptions_julia_min_version => HtmlElem(:GeneralOptions_julia_min_version, :input, String[], :text, :GeneralOptions_form, "1.6.0", false),
    :GeneralOptions_makerepo => HtmlElem(:GeneralOptions_makerepo, :input, String[], :checkbox, :GeneralOptions_form, "on", false),
    :GeneralOptions_proj_name => HtmlElem(:GeneralOptions_proj_name, :input, String[], :text, :GeneralOptions_form, "LokalTestProjNotPkg919459", false),
    :GeneralOptions_proj_pkg => HtmlElem(:GeneralOptions_proj_pkg, :textarea, String[], :textarea, :GeneralOptions_form, "Dates", nothing),
    ...
    :Git_email => HtmlElem(:Git_email, :input, String[], :text, :Git_form, "nomail@nowhere.org", false),
    ...
    :Git_name => HtmlElem(:Git_name, :input, String[], :text, :Git_form, "NoName", false),
    ...
    :Project_Choice => HtmlElem(:Project_Choice, :input, String[], :radio, :use_purpose_form, "Project", true),
    :ProjectFile_version => HtmlElem(:ProjectFile_version, :input, String[], :text, :ProjectFile_form, "0.1.2", false),
    :Readme_destination => HtmlElem(:Readme_destination, :input, String[], :text, :Readme_form, "README.txt", false),
    ...
    :Use_GitHubActions => HtmlElem(:Use_GitHubActions, :input, ["TogglePlugin"], :checkbox, :GitHubActions_form, "Use_GitHubActions", false),
    :Use_License => HtmlElem(:Use_License, :input, ["TogglePlugin"], :checkbox, :License_form, "Use_License", false),
    :Use_ProjectFile => HtmlElem(:Use_ProjectFile, :input, ["TogglePlugin"], :checkbox, :ProjectFile_form, "Use_ProjectFile", true),
    :Use_Readme => HtmlElem(:Use_Readme, :input, ["TogglePlugin"], :checkbox, :Readme_form, "Use_Readme", false),
    ...
    :Use_SrcDir => HtmlElem(:Use_SrcDir, :input, ["TogglePlugin"], :checkbox, :SrcDir_form, "Use_SrcDir", false),
