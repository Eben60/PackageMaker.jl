...
fv = Dict{Symbol, HtmlElem}(
    ...
    :Save_Configuration_config_name => HtmlElem(:Save_Configuration_config_name, :input, String[], :text, :Save_Configuration_form, "", false), 
    :Use_Codecov => HtmlElem(:Use_Codecov, :input, ["TogglePlugin"], :checkbox, :Codecov_form, "Use_Codecov", true), 
    ...
    :GeneralOptions_docstring => HtmlElem(:GeneralOptions_docstring, :textarea, String[], :textarea, :GeneralOptions_form, "This is a PackageMakerTestPackage for PackageMaker testing.", nothing), 
    ...
    :GeneralOptions_proj_pkg => HtmlElem(:GeneralOptions_proj_pkg, :textarea, String[], :textarea, :GeneralOptions_form, "ShareAdd.jl\n\n Plots  \nDataFrames", nothing), 
    ...
    :ProjectFile_version => HtmlElem(:ProjectFile_version, :input, String[], :text, :ProjectFile_form, "0.0.1", false), 
    ...
    :GeneralOptions_proj_name => HtmlElem(:GeneralOptions_proj_name, :input, String[], :text, :GeneralOptions_form, "PackageMakerTestPackage", false), 
    ...
    :GitHubActions_coverage => HtmlElem(:GitHubActions_coverage, :input, String[], :checkbox, :GitHubActions_form, "on", true), 
