...
fv = Dict{Symbol, HtmlElem}(
    ...
    :GeneralOptions_authors => HtmlElem(:GeneralOptions_authors, :input, String[], :text, :GeneralOptions_form, "Eben007 <E007@nowhere.org>", false),
    :GeneralOptions_docstring => HtmlElem(:GeneralOptions_docstring, :textarea, String[], :textarea, :GeneralOptions_form, "Short package info.\nThis will be put into the package docstring.", nothing),
    ...
    :GeneralOptions_julia_min_version => HtmlElem(:GeneralOptions_julia_min_version, :input, String[], :text, :GeneralOptions_form, "1.11.0", false),
    :GeneralOptions_makerepo => HtmlElem(:GeneralOptions_makerepo, :input, String[], :checkbox, :GeneralOptions_form, "on", false),
    :GeneralOptions_proj_name => HtmlElem(:GeneralOptions_proj_name, :input, String[], :text, :GeneralOptions_form, "LocalTestProj616523", false),
    :GeneralOptions_proj_pkg => HtmlElem(:GeneralOptions_proj_pkg, :textarea, String[], :textarea, :GeneralOptions_form, "Unicode", nothing),
    :GeneralOptions_project_dir => HtmlElem(:GeneralOptions_project_dir, :input, String[], :text, :GeneralOptions_form, temp_dir, false),
    :GeneralOptions_repopublic => HtmlElem(:GeneralOptions_repopublic, :input, String[], :checkbox, :GeneralOptions_form, "on", false),
    :GeneralOptions_user_name => HtmlElem(:GeneralOptions_user_name, :input, String[], :text, :GeneralOptions_form, "Eben007", false),
    ...
    :Git_ignore => HtmlElem(:Git_ignore, :textarea, String[], :textarea, :Git_form, "", nothing),
    ...
    :License_destination => HtmlElem(:License_destination, :input, String[], :text, :License_form, "LICENSE", false),
    :License_name => HtmlElem(:License_name, :input, ["menu_target"], :text, :License_form, "MIT", false),
    ...
    :LocalPackage_Choice => HtmlElem(:LocalPackage_Choice, :input, String[], :radio, :use_purpose_form, "LocalPackage", true),
    ...
    :Save_Configuration_config_name => HtmlElem(:Save_Configuration_config_name, :input, ["menu_target"], :text, :Save_Configuration_form, "", false),
    :Save_Configuration_config_name_1 => HtmlElem(:Save_Configuration_config_name_1, :input, String[], :radio, :Save_Configuration_form, "1.10.9", false),
    :Save_Configuration_config_name_2 => HtmlElem(:Save_Configuration_config_name_2, :input, String[], :radio, :Save_Configuration_form, "1.10.9a", false),
    :Save_Configuration_config_name_3 => HtmlElem(:Save_Configuration_config_name_3, :input, String[], :radio, :Save_Configuration_form, "1.10.9b", false),
    :Save_Configuration_config_name_4 => HtmlElem(:Save_Configuration_config_name_4, :input, String[], :radio, :Save_Configuration_form, "1.10.9c", false),
    :Save_Configuration_config_name_5 => HtmlElem(:Save_Configuration_config_name_5, :input, String[], :radio, :Save_Configuration_form, "1.11.4", false),
    :Save_Configuration_config_name_6 => HtmlElem(:Save_Configuration_config_name_6, :input, String[], :radio, :Save_Configuration_form, "TestPackage01", false),
    :Save_Configuration_config_name_7 => HtmlElem(:Save_Configuration_config_name_7, :input, String[], :radio, :Save_Configuration_form, "is a project", false),
    :Save_Configuration_config_name_8 => HtmlElem(:Save_Configuration_config_name_8, :input, String[], :radio, :Save_Configuration_form, "is pkg ProjFile only", false),
    :Save_Configuration_config_name_9 => HtmlElem(:Save_Configuration_config_name_9, :input, String[], :radio, :Save_Configuration_form, "piracy", false),
    ...
    :Tests_aqua => HtmlElem(:Tests_aqua, :input, String[], :checkbox, :Tests_form, "on", false),
    ...
    :Use_Tests => HtmlElem(:Use_Tests, :input, ["TogglePlugin"], :checkbox, :Tests_form, "Use_Tests", false),
)    
